...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-info">
                ...
                <strong>提示:</strong> 推荐标签添加后生成的id可关联至文章中。
            </div>
        </div>
    </div>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form action="{{ url('/webmaster/recommend/add') }}" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> 标题 <span class="text-danger">[必填]</span> </label>

                        <div class="col-sm-9">
                            <input type="text" name="title" placeholder="不超过12个字" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="description" placeholder="不超过30个字" class="col-xs-10 col-sm-5" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="url" placeholder="例:http://m.shucong.com" class="col-xs-10 col-sm-5" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="tag" placeholder="例:情感生活" class="col-xs-10 col-sm-5" />
                            <span class="help-inline col-xs-12 col-sm-7">
