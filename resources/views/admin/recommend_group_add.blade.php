...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12 dataTables_wrapper">
            <div class="row">
                <form action="{{ url('/webmaster/recommend/group/add') }}" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> 推荐组名称 <span class="text-danger">[必填]</span> </label>

                        <div class="col-sm-9">
                            <input type="text" name="name" placeholder="例:情感生活相关" class="col-xs-10 col-sm-5" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="recommend_id" placeholder="例:1,6,15,24,33" class="col-xs-10 col-sm-5" />
                            <span class="help-inline col-xs-12 col-sm-7">
