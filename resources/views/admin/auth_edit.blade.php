            ...
            <div class="col-sm-12">
                <form action="{{ url('/webmaster/auth/add') }}" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" placeholder="例:system" class="col-xs-10 col-sm-5" value="{{ $list->name }}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="alias" placeholder="例:系统管理" class="col-xs-10 col-sm-5" value="{{ $list->alias }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="url" placeholder="例:webmaster/dashboard" class="col-xs-10 col-sm-5" value="{{ $list->url }}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="description" placeholder="例:系统管理模块" class="col-xs-10 col-sm-5" value="{{ $list->description }}" />
                            <span class="help-inline col-xs-12 col-sm-7">
                                <span class="middle"></span>
                            </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="col-sm-6" name="pid">
                                <option value="0" @if($list->pid == 0)selected="true"@endif>无(当前为顶级)</option>
                                @foreach($auth as $item)
                                    <option value="{{ $item->id }}" @if($list->pid == $item->id)selected="true"@endif>@if(0 == $item->pid)顶级菜单:@else普通菜单:@endif{{ $item->alias }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                            <label>
                                <input name="type" class="ace ace-switch ace-switch-7" type="checkbox" value="1" @if($list->id == $item->id)checked="true"@endif />
                                <span class="lbl"></span>
                            </label>
                        </div>
                    </div>
