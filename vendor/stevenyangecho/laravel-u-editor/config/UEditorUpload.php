...
*/
    ...
    'upload' => [
        ...
        "imagePathFormat" => "/uploads/ueditor/php/upload/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "scrawlPathFormat" => "/uploads/ueditor/php/upload/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "snapscreenPathFormat" => "/uploads/ueditor/php/upload/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "catcherPathFormat" => "/uploads/ueditor/php/upload/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "imageManagerListPath" => "/uploads/ueditor/php/upload/images/", /* 指定要列出图片的目录 */
