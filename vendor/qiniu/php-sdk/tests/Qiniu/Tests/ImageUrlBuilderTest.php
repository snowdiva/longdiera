...
class ImageUrlBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThumbutl()
    {
        ...
        $url2 = $url . '?watermark/1/gravity/SouthEast/dx/0/dy/0/images/'
    ...
    public function waterImgTest()
    {
        ...
        // 水印简单测试
        $this->assertEquals(
            $url . '?watermark/1/images/aHR0cDovL2RldmVsb3Blci5xaW5pdS5jb20vcmVzb3VyY2UvbG9nby0yLmpwZw=='
        ...
        // 多参数测试
        $this->assertEquals(
            $url2 . '|watermark/1/images/aHR0cDovL2RldmVsb3Blci5xaW5pdS5jb20vcmVzb3VyY2UvbG9nby0yLmpwZw=='
            . '/dissolve/100/gravity/SouthEast/',
